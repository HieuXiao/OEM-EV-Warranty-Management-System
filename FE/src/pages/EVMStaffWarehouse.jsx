  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError("Failed to load warehouse data. Please check the API connection and token.")
        setWarehouses([])
        setParts([])
      } finally {
        setLoading(false)
        ...
        <div className="p-4 md:p-6 lg:p-8">
          <div className="space-y-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button onClick={() => setShowCreateWarehouse(true)} className="flex items-center space-x-2">
      ...
      <Dialog open={showCreateWarehouse} onOpenChange={setShowCreateWarehouse}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>Add a new warehouse to manage your inventory.</DialogDescription>
          </DialogHeader>
