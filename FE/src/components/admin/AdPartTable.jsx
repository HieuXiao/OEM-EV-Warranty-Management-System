...
/**
 * @component
 * @description Displays a paginated table of parts with a search feature.
...
export default function PartsTable({ parts, onRowClick, loading }) {
   ...
   * @description Filters the main list of parts based on the current search term across key fields.
   * @returns {Object[]} The filtered array of part objects.
   */
   ...
   * @description Moves to the next page, preventing overflow past the total number of pages.
   */
   ...
   * @description Moves to the previous page, preventing underflow past page 1.
   */
   ...
   * @description Updates the search term and resets the current page to 1.
   */
      ...
      <CardHeader>
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <div>
            ...
            <CardDescription>
              Click on a row to view details and policies.
            </CardDescription>
          </div>
                  ...
                  <TableBody>
                    {displayParts.map((part) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge
                            variant={part.isEnable ? "default" : "secondary"}
                          >
