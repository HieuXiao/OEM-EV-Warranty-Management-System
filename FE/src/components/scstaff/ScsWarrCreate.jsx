...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0 rounded-2xl flex flex-col">
        
...
          <form id="warranty-claim-form" onSubmit={handleSubmitNewClaim} className="space-y-4">
...
            disabled={isSubmitting || vinUnderWarranty}
          >
